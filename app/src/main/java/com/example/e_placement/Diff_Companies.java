...
public class Diff_Companies extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("E-Recruitment System");
        ...
        mySearchView=(SearchView)findViewById(R.id.searchv1);
        ...
        listnewsData.add(new AdapterItems(R.drawable.amazon,"Amazon"));
        listnewsData.add(new AdapterItems(R.drawable.mslogo,"Microsoft"));
        listnewsData.add(new AdapterItems(R.drawable.google,"Google"));
        listnewsData.add(new AdapterItems(R.drawable.apple,"Apple"));
        listnewsData.add(new AdapterItems(R.drawable.dsap,"SAP Labs"));
